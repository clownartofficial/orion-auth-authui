...
.grid-overlay {
  ...
  mask-image: radial-gradient(ellipse 800px 600px at 40% 50%, black 20%, transparent 70%);
  -webkit-mask-image: radial-gradient(ellipse 800px 600px at 40% 50%, black 20%, transparent 70%);
  opacity: 0.5;
  pointer-events: none;
}
