...
<template>
  <V2Card path="auth.orion.io / <b>consent</b>">
    <div class="v2-card__head">
      <h1 class="v2-card__title">Autoriser l'acces</h1>
      <p class="v2-card__sub"><strong>{{ state.clientName }}</strong> demande l'acces a votre compte.</p>
    </div>
